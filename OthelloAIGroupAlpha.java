...
public class OthelloAIGroupAlpha implements IOthelloAI { 
   /**
    ...
    * check the score at that point, and return that value. 
    * 
    *
    ...
    * @param betterAIcolour The colour of OthelloAIGroupAlpha. White or black. Will always look at that colours tokens. 
    ...
    */
    ...
    public Position decideMove (GameState s) { 
        ...
        if (moves.size()==1) {
        ...
        else {                                              // If there are available moves, feed each into MiniMax, and return move with the highest utility for OthelloAIGroupAlpha. 
            int betterAIcolour;
            ...
            int depth = 2;                     // set depth here. Gets funky above 5.
